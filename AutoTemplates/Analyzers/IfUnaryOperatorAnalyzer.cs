// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IfUnaryOperatorAnalyzer.cs" company="Sitecore A/S">
//   Copyright (C) by Sitecore A/S
// </copyright>
// <summary>
//   Defines the <see cref="IfUnaryOperatorAnalyzer" /> class.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace PredictiveCodeSuggestions.AutoTemplates.Analyzers
{
  ...
  /// <summary>Defines the <see cref="IfUnaryOperatorAnalyzer"/> class.</summary>
  public class IfUnaryOperatorAnalyzer : BlockStatementAnalyzer
  {
    ...
    public override bool CanHandle(IStatement statement)
    {
      ...
      var referenceExpression = unaryOperatorExpression.Operand as IReferenceExpression;
    ...
    public override AutoTemplateScope Handle(IStatement statement)
    {
      ...
      var op = unaryOperatorExpression.OperatorSign.GetTokenType().TokenRepresentation;
      ...
      var key = string.Format("If expression {1} \"{0}\"", name, op);
