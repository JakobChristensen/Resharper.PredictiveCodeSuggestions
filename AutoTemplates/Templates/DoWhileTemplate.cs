// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DoWhileTemplate.cs" company="Sitecore A/S">
//   Copyright (C) by Sitecore A/S
// </copyright>
// <summary>
//   Defines the <see cref="DoWhileTemplate" /> class.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace PredictiveCodeSuggestions.AutoTemplates.Templates
{
  ...
  /// <summary>Defines the <see cref="DoWhileTemplate"/> class.</summary>
  public class DoWhileTemplate : StatementTemplate
  {
    ...
    {
      return statement is IDoStatement;
    }
    ...
    public override StatementDescriptor Handle(IStatement statement, AutoTemplateScope scope)
    {
      ...
      {
        return new StatementDescriptor(scope, string.Format("do {{ $END$ }} while ({0});", expressionDescriptor.Template), expressionDescriptor.TemplateVariables);
      }

      var result = new StatementDescriptor(scope)
      {
        Template = string.Format("do {{ $END$ }} while ({0});", condition.GetText())
      };
