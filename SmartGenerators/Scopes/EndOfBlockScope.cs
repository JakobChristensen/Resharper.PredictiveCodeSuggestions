// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EndOfBlockScope.cs" company="Sitecore A/S">
//   Copyright (C) by Sitecore A/S
// </copyright>
// <summary>
//   Defines the <see cref="EndOfBlockScope" /> class.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace PredictiveCodeSuggestions.SmartGenerators.Scopes
{
  ...
  /// <summary>Defines the <see cref="EndOfBlockScope"/> class.</summary>
  public class EndOfBlockScope : ScopeBase
  {
    ...
    {
      return context.CanGenerateReturn();
    }
