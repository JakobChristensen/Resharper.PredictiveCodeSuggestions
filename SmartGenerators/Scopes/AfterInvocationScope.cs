// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AfterInvocationScope.cs" company="Sitecore A/S">
//   Copyright (C) by Sitecore A/S
// </copyright>
// <summary>
//   Defines the <see cref="AfterInvocationScope" /> class.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace PredictiveCodeSuggestions.SmartGenerators.Scopes
{
  ...
  /// <summary>Defines the <see cref="AfterInvocationScope"/> class.</summary>
  public class AfterInvocationScope : ScopeBase
  {
    ...
    public override string GetShortcut(Dictionary<string, string> parameters)
    {
      ...
      return string.Format("After call to \"{0}\"", methodName);
    }
