// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EmptyFileScope.cs" company="Sitecore A/S">
//   Copyright (C) by Sitecore A/S
// </copyright>
// <summary>
//   Defines the <see cref="EmptyFileScope" /> class.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace PredictiveCodeSuggestions.SmartGenerators.Scopes
{
  ...
  /// <summary>Defines the <see cref="EmptyFileScope"/> class.</summary>
  public class EmptyFileScope : ScopeBase
  {
    ...
    {
      return context.CanGenerateEmptyFile(parameters);
    }
