// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ReturnGenerator.cs" company="Sitecore A/S">
//   Copyright (C) by Sitecore A/S
// </copyright>
// <summary>
//   Defines the <see cref="ReturnGenerator" /> class.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace PredictiveCodeSuggestions.Generators
{
  ...
  /// <summary>Defines the <see cref="ReturnGenerator"/> class.</summary>
  public class ReturnGenerator : GeneratorBase
  {
    #region Constructors and Destructors

    /// <summary>Initializes a new instance of the <see cref="ReturnGenerator"/> class.</summary>
    /// <param name="model">The model.</param>
    /// <param name="text">The text.</param>
    /// <param name="liveTemplate">The live template.</param>
    public ReturnGenerator(ReturnPopulator.Model model, string text, string liveTemplate)
    {
      this.Model = model;
      this.Text = text;
    ...
    public ReturnGenerator(ReturnPopulator.Model model, string text, string liveTemplate, params string[] variables)
    {
      this.Model = model;
      this.Text = text;
      this.LiveTemplate = liveTemplate;
    ...
    public ReturnPopulator.Model Model { get; private set; }
