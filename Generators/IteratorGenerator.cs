// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IteratorGenerator.cs" company="Sitecore A/S">
//   Copyright (C) by Sitecore A/S
// </copyright>
// <summary>
//   Defines the <see cref="IteratorGenerator" /> class.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace PredictiveCodeSuggestions.Generators
{
  ...
  /// <summary>Defines the <see cref="IteratorGenerator"/> class.</summary>
  public class IteratorGenerator : GeneratorBase
  {
    ...
    public IteratorPopulator.Model Model { get; private set; }
    ...
    {
      return "AgentJohnson.IteratorGenerator";
    }
